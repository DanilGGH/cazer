...
$(window).on('load', function () {
	setInterval(function () {
		...
		setTimeout(function () {
			$(".count-style").html('<span class="okk">1893</span>');
			$('.okk').fadeIn(300);
		}, 400);
		setTimeout(function () {
			$('.okk').fadeOut(300);
		...
		setTimeout(function () {
			$(".count-style").html('<span class="okk">1902</span>');
			$('.okk').fadeIn(300);
		}, 6900);
		setTimeout(function () {
			$('.okk').fadeOut(300);
		...
		setTimeout(function () {
			$(".count-style").html('<span class="okk">1899</span>');
			$('.okk').fadeIn(300);
		}, 11300);
		setTimeout(function () {
			$('.okk').fadeOut(300);
		...
		setTimeout(function () {
			$(".count-style").html('<span class="okk">1889</span>');
			$('.okk').fadeIn(300);
		}, 15300);
		setTimeout(function () {
			$('.okk').fadeOut(300);
...
$(document).ready(function() {
    ...
    $("#custom-form").on("submit", function(e) {
        ...
        if ($(".cahek-box:checked").length !== 2) {
            isValid = false;
            $(".cahek-box").addClass("brred");
        } else {
            $(".cahek-box").removeClass("brred");
        }
